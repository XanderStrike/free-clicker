...
class ResponsesControllerTest < ActionController::TestCase
  ...
  test "should create response" do
    assert_difference('Response.count') do
      post :create, response: { letter: @response.letter, question_id: @response.question_id }
    end
  ...
  test "should update response" do
    put :update, id: @response, response: { letter: @response.letter, question_id: @response.question_id }
    assert_redirected_to response_path(assigns(:response))
  end
